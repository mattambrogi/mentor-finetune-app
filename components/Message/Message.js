...
export default function Message({
  type,
  content,
  // typingCompleteHandler and showLastMessageProperly can also be removed if not used elsewhere
}) {
  return (
    <div className={styles.Message}>
      <div
        className={
          type === 'user' ? styles.MessageIconUser : styles.MessageIconBot
        }
      >
        <Icon type={type} />
      </div>
...
// Assuming Icon component remains unchanged
